                  ...
                  <div class="box-left">
                    ...
                    <div class="bottom-line">
                      ...
                      <div class="btn-complain">
                        <a href="#" data-target="#complain-modal" data-toggle="modal">Пожаловаться</a>
                      </div>
                    </div>
                  </div>
                  <div class="box-right">
              ...
              <div class="page-about clearfix" data-magellan-destination="about-movie" id="about-movie">
                <div class="block-about-movie">
                  ...
                  <div class="about-wrapper clearfix">
                    <div class="box-left">
                    <!-- slider with vertical posters  -->
                    <?php include($_SERVER['DOCUMENT_ROOT'] . '/views/partials/_slider_posters.php'); ?>
                    <!--end slider with vertical posters  -->
                    ...
                    <div class="box-right">
                      ...
                      <ul class="assessment-list">
                        <li>
                          <noindex><div class="field-assessment kinopoisk"><a href="//kinopoisk.ru/film/2717/" rel="nofollow" target="_blank"><span class="icon-kinopoisk"></span></a>7.6</div></noindex>
                        </li>
                        <li>
                          <noindex><div class="field-assessment imdb"><a href="#" rel="nofollow"><span class="icon-Imdb"></span></a>8.1</div></noindex>
                        </li>
                      </ul>
                      </div>
                      <div class="movie-info-fields js-panel is-collapsed">
                        <!-- display first four properties -->
                        <!-- 
                          yes i know this is additional condition but it's
                          very efficient way avoid repeatings of content;
                          another variant is — not hidding content and show all properties,
                          then we dont need more button to interapt our foreach of items
                        -->
                        ...
                        <!-- then display this button -->
                        <div class="field-item field-item__more">
                        <div class="js-panel-btn c-more">
                          <div class="c-more__help">
                            <span class="c-more__anchor">Все характеристики</span>
                          </div>
                        </div>
                        </div>
                        <!-- then display other ptoperties -->
                        <div class="field-item">
                ...
                <div class="block-movie-gallery">
                 ...
                 <?php include($_SERVER['DOCUMENT_ROOT'] . '/views/partials/_slider_trailers.php'); ?>
...
<?php include($_SERVER['DOCUMENT_ROOT'] . '/views/partials/_modal_complain.php'); ?>
