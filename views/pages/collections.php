...
<!--      <div id="BgEacDeJ"></div>-->
    <main role="main" class="main">
        <div class="box-breadcrumbs box-breadcrumbs--in-header">
            <div class="row">
      ...
      <div class="l-main">
        <div class="page-category fixed-nav socials-bottom">
            <div class="box-breadcrumbs box-breadcrumbs--in-main">
                <ul class="breadcrumbs">
                    <li>
                        <a href="/"><span>Главная</span></a>
                    </li>
          ...
          <?php include('./views/content/index_content.php'); ?>
        </div>
      </div>
    </main>
  </div>
