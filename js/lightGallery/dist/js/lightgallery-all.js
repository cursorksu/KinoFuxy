...
(function() {
    ...
    Plugin.prototype.structure = function() {
        ...
        //console.log(_this.$el[0].dataset.link);
        ...
        template = '<div class="lg-outer ' + this.s.addClass + ' ' + this.s.startClass + '">' +
            ...
            '<span class="lg-title">'+_this.$el[0].title+'</span>' +
            '<span class="lg-close lg-icon"></span>' +
            '</div>' +
            controls +
            subHtmlCont +
            '<div class="lg-link"><a class="btn" target="_blank" href="'+_this.$el[0].dataset.link+'"><span class="help">смотреть фильм</span></a></div>' +
            '</div>' +
            '</div>';
